"""
M-Pesa integration utilities for Freelance Marketplace
"""
...
from config import (
    ...
    MPESA_SHORTCODE, MPESA_CALLBACK_URL, MPESA_PRODUCTION,
    MPESA_SECURITY_CREDENTIAL
)

# Use sandbox URLs for testing
BASE_URL = "https://api.safaricom.co.ke" if MPESA_PRODUCTION else "https://sandbox.safaricom.co.ke"
...
def b2c_payout(phone_number, amount, remarks="Payout"):
    ...
    try:
        response = requests.post(b2c_url, json=payload, headers=headers, timeout=10)
